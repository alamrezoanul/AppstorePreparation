...
- (Annotation *)getAnnotation:(NSString *)filePath withPage:(NSNumber *)page
{
    ...
    else
    {
        ...
        for(Annotation *obj in objects) {
            NSLog(@"obj.file.filePath: %@", obj.file.filePath);
            
            if( [filePath isEqualToString:obj.file.filePath] ) {
                annotation = obj;
                break;
            }
        }
    ...
    //NSLog(@"-filePath: %@", filePath);
    //NSLog(@"-annotation.file.filePath: %@", annotation.file.filePath);
    
    //if ([filePath isEqualToString: annotation.file.filePath]) {
        return annotation;
    //}
    //return nil;
}
